...
(async () => {
    ...
    try {
        ...
        await voteModule.propose(
            ...
            [
                {
                    // Again were sending ourselves 0 ETH. Just sending our own token. 
                    nativeTokenValue: 0,
                    transactionData: tokenModule.contract.interface.encodeFunctionData(
                        // Were doing a transfer from the treasury to our wallet. 
                        "transfer",
                        [
        ...
        console.log("✅ Successfully created proposal to reward ourselves from the treasury, lets hope people vote for it!");
    } catch (error) {
